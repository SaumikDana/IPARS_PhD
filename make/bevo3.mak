...
#HYPRE_DIR  = /home/bganis/hypre-2.11.2/src/
...
VTKPATH = /usr/lib64/vtk
VTKINCL = /usr/include/vtk
VTKLIBS = -lvtkCommonCore -lvtkCommonDataModel  \
          -lvtkCommonExecutionModel -lvtkCommonSystem \
          -lvtkCommonMath -lvtkCommonMisc \
          -lvtkCommonTransforms -lvtksys \
          -lvtkIOCore -lvtkIOXML
#VTKLIBS = -lvtkWrappingTools

ICES_MKL_LIB = ${MKLROOT}/lib/intel64 # dana
LFLAGS   = -i_dynamic -Wl,-rpath,$(ICES_MKL_LIB) $(LIBS_HYPRE) $(DAGHMB_LFLAGS) \
...
$(EXENAM): size $(OBJST) $(LIBS_TO_STAMP) 
	$(LINK) $(OBJST) -o $(EXENAM) $(LFLAGS) $(LIBS) $(BLAS_LIB) -lstdc++ 
	rm -f logstamp
	date > logstamp
	touch logstamp
