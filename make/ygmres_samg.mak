...
SOLVELIB = $(LAPACK_LIB) $(BLAS_LIB) $(LIBAMG)

GMRESLIB = $(LAPACK_LIB) $(BLAS_LIB) $(LIBAMG)   

# LIBAMG is defined in platform makefile
...
mslblk$(O): mslblk.c  r8blas.h r8lapack.h cfsimple.h samg.h
