...
#PARALLIB = -L/bgsys/drivers/ppcfloor/comm/lib -lmpich.rts -lmsglayer.rts -lrts.rts -ldevices.rts
...
LFLAGS   = -O2 -lm -lstdc++ $(MACE_LFLAGS) $(DAGHMB_LFLAGS) \
...
FORT_LIB = -L/opt/ibmcmp/xlf/bg/11.1/bglib -lxlf90_r -lxlfmath -lxl \
           -L/opt/ibmcmp/xlsmp/bg/1.7/bglib -lxlomp_ser
...
$(EXENAM): $(OBJST) $(LIBS_TO_STAMP) 
	$(LINK) $(OBJST) -o $(EXENAM) $(LFLAGS) $(LIBS) $(BLAS_LIB) $(FORT_LIB) 
