...
c      OPEN(UNIT=2, FILE='perm.dat',STATUS='UNKNOWN')
c      OPEN(UNIT=3, FILE='rock.dat',STATUS='UNKNOWN')
      OPEN(UNIT=4, FILE='wellinput.dat',STATUS='UNKNOWN')      
...
C
      ...
      val1 = -1.d0
      val4 = 1.d0
      call map_phycord(val1,val2,val3,LX,LY,LZ,TX,TY,TZ) 
      call map_phycord(val4,val2,val3,LX,LY,LZ,BX,BY,BZ) 

      WRITE(4,222)''
      WRITE(4,222)'WELLNAME(1) = "WELL 1, BLOCK 1"'
      WRITE(4,222)'KINDWELL(1) = 1'
      WRITE(4,555)'WELLTOP(1 TO 3,1,1) =', TX, TY,TZ
      WRITE(4,555)'WELLBOTTOM(1 TO 3,1,1) =', BX, BY,BZ
      WRITE(4,222)'WELLPQ(1) Block'
      WRITE(4,222)'  Interpolation Linear'
      WRITE(4,222)'  Extrapolation Constant '
c      WRITE(4,222)'  Data    0. 1200.'
c      WRITE(4,222)'         50. 1600.'
c      WRITE(4,222)'        100. 1200.'
c      WRITE(4,222)'        150. 1600.' 
c      WRITE(4,222)'        200. 1200.'
      WRITE(4,222)'  Data    0. 1600.'
      WRITE(4,222)'EndBlock'
C
C INJECTION WELL 2
C
      val2 = 1.d0 - HY/2.d0
      ...
      WRITE(4,222)''
      WRITE(4,222)'WELLNAME(2) = "WELL 2, BLOCK 1"'
      WRITE(4,222)'KINDWELL(2) = 1'
      WRITE(4,555)'WELLTOP(1 TO 3,1,2) =', TX, TY,TZ
      WRITE(4,555)'WELLBOTTOM(1 TO 3,1,2) =', BX, BY,BZ
      WRITE(4,222)'WELLPQ(2) Block'
      WRITE(4,222)'  Interpolation Linear'
      WRITE(4,222)'  Extrapolation Constant '
c      WRITE(4,222)'  Data    0. 1200.'
c      WRITE(4,222)'         50. 1600.'
...
C
      ...
      WRITE(4,222)''
      WRITE(4,222)'WELLNAME(3) = "WELL 3, BLOCK 1"'
      WRITE(4,222)'KINDWELL(3) = 1'
      WRITE(4,555)'WELLTOP(1 TO 3,1,3) =', TX, TY,TZ
      WRITE(4,555)'WELLBOTTOM(1 TO 3,1,3) =', BX, BY,BZ
      WRITE(4,222)'WELLPQ(3) Block'
      WRITE(4,222)'  Interpolation Linear'
      WRITE(4,222)'  Extrapolation Constant '
c      WRITE(4,222)'  Data    0. 1200.'
c      WRITE(4,222)'         50. 1600.'
...
C
      ...
      WRITE(4,222)''
      WRITE(4,222)'WELLNAME(4) = "WELL 4, BLOCK 1"'
      WRITE(4,222)'KINDWELL(4) = 1'
      WRITE(4,555)'WELLTOP(1 TO 3,1,4) =', TX, TY,TZ
      WRITE(4,555)'WELLBOTTOM(1 TO 3,1,4) =', BX, BY,BZ
      WRITE(4,222)'WELLPQ(4) Block'
      WRITE(4,222)'  Interpolation Linear'
      WRITE(4,222)'  Extrapolation Constant '
c      WRITE(4,222)'  Data    0. 1200.'
c      WRITE(4,222)'         50. 1600.'
...
C
      ...
      WRITE(4,222)''
      WRITE(4,222)'WELLNAME(5) = "WELL 5, BLOCK 1"'
      WRITE(4,222)'KINDWELL(5) = 31'
      WRITE(4,555)'WELLTOP(1 TO 3,1,5) =', TX, TY,TZ
      WRITE(4,555)'WELLBOTTOM(1 TO 3,1,5) =', BX, BY,BZ
      WRITE(4,222)'WELLPQ(5) Block'
      WRITE(4,222)'  Interpolation Linear'
      WRITE(4,222)'  Extrapolation Constant '
      WRITE(4,222)'  Data  0.  1000.'
      WRITE(4,222)'EndBlock'
 ...
 444  FORMAT(6(I4,3X))
 555  FORMAT(A25,3(F18.10,2X))
C 30   FORMAT(A22,3(F18.10,2X))
