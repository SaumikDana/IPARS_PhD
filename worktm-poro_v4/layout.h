C  LAYOUT.H - MEMORY MANAGEMENT AND PARALLEL DATA
     ...
     &  DATASPACES,MPI_EXTERNAL,ADAPTIVITY

      COMMON /LAYOUT/ GRAV,GMAG(10),DOWN(3,10),
     & XREC(201,10),
     & YREC(205,10), ZREC(205,10),CONV_FACTOR,
     & PRCMAP(6000000), NUMBLK,ILAY,JLAY,KLAY,MAXREF,NUMTMP,NUMMODEL,
     & MSGS(4,10),MODPROC(19,1024),NEMOD(19),
     & MSGTRG(20,4,10),
     & MSGSRC(20,4,10),LSTIND,MSGSNDF(20,4,10),
     & MSGSNDL(20,4,10),MSGRCVF(20,4,10),
     & MSGRCVL(20,4,10),MSGIND(2,40000),N0MAP(10),
     & NYMAP(10),KNDGRD,METHOD,EV_PRCBLK,NETOTR0,NETOTR(19),
     & MYBLK(10),
     & DXREC(200,10),DYREC(204,10),
     & DZREC(204,10),XYZ111(3,10),
     & MFMFE_BRICKS,PLOT_MYPRC,DEALII,
     & DATASPACES,MPI_EXTERNAL,ADAPTIVITY

CBW EXTENTION TO NODAL BASED COMMUNICATION
      INTEGER PRCMAPN, N0MAPN
      COMMON /LAYOUTN/ PRCMAPN(2*6000000), N0MAPN(10)
CBW
