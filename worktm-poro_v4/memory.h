...
#define MAXBLK   10    // Maximum number of grid blocks
#define MAXPRC   1024    // Maximum number of processors
#define MAXBNAM  60    // Maximum block name length
#define MAXARY   400    // Maximum number of arrays
#define MAXANAM  20    // Maximum array name length
#define MAXARG   400    // Maximum total number of work routine arguments
