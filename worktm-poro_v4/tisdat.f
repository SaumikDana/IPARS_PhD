...
ctm   TAMEEM
      F_TOLERANCE = 1.E-5
      CALL GETVAL('F_TOLERANCE ',F_TOLERANCE,'R8',0,0,0,0,NDUM,NERR)

C     COMPUTE_NORM = 0 (DO NOT COMPUTE CONVERGENCE NORMS)
C                  = 1 (COMPUTE CONVERGENCE NORMS)

      COMPUTE_NORM = 0
      CALL GETVAL('COMPUTE_NORM ',COMPUTE_NORM,'I4',0,0,0,0,NDUM,NERR)
